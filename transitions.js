(function () {
  ...
  /* ── Star-warp (eased): same streaking stars but speed follows sin bell-curve ── */
  function playStarWarpEased(destUrl) {
    ...
    function frame(now) {
      ...
      var speed = MAX_SPEED * Math.sin(t * Math.PI);

      ctx.fillStyle = 'rgba(0,0,12,' + (0.12 + Math.sin(t * Math.PI) * 0.55) + ')';
